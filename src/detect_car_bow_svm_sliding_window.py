...
if not os.path.isdir('CarData'):
    print(
        ...
        'https://github.com/stackprogramer/ObjectDetectorProject.github.io/blob/master/database%20std/CarData.tar.gz'
        'into the same folder as this scriptr.')
    exit(1)
    ...
    for resized in pyramid(gray_img):
        for x, y, roi in sliding_window(resized):
            ...
            if prediction[1][0][0] == 1.0:
                raw_prediction = svm.predict(descriptors,
